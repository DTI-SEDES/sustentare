...
def load_sample_data():
    ...
    # Dados de destinação (2017-2025) - CORRETO
    dest_data = {
    ...
    # Dados de doações CORRIGIDOS - todos com mesmo tamanho
    doacao_data = {
        'Ano': [2017, 2017, 2017, 2017, 2018, 2018, 2018, 2018, 2018, 2018, 
        ...
        'Mês': ['MAI', 'NOV', 'JAN', 'JUN', 'AGO', 'NOV', 'JAN', 'FEV', 'MAR', 'ABR', 
                'MAI', 'JUN', 'SET', 'DEZ', 'FEV', 'ABR', 'JUN', 'JUL', 'AGO', 'SET', 
                'MAR', 'JUN', 'JUL', 'AGO', 'SET', 'OUT', 'NOV', 'DEZ', 'FEV', 'JUN', 
                'JUL', 'AGO', 'SET', 'MAR', 'MAI', 'JUN', 'JUL', 'AGO', 'SET', 'OUT', 
                'NOV', 'DEZ', 'FEV', 'MAR', 'ABR', 'MAI', 'JUN', 'JUL', 'AGO', 'SET', 
                'OUT', 'NOV', 'DEZ', 'JAN', 'FEV', 'MAR', 'ABR', 'JUN', 'JUL', 'AGO', 
                'SET', 'OUT', 'NOV', 'FEV', 'MAR', 'ABR', 'MAI', 'JUN', 'JUL', 'AGO', 
                'SET', 'OUT', 'NOV', 'DEZ', 'JAN', 'FEV', 'MAR', 'ABR', 'MAI', 'JUN'],
        'Quantidade': [45, 24, 11, 26, 17, 18, 10, 40, 5, 70, 
                       20, 33, 35, 11, 2, 20, 33, 3, 5, 3, 
                       15, 5, 15, 5, 3, 11, 4, 44, 48, 20, 
                       10, 10, 41, 8, 21, 70, 30, 29, 10, 74, 
